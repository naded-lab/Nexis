...
private val ButtonBorderGray = Color(0xFFD9DCE1)
private val ButtonTextDark = Color(0xFF23262B)
...
fun NexisLoginScreen(
    ...
    Column(
        modifier = Modifier
            .fillMaxSize()
            .background(
                Brush.linearGradient(colors = listOf(NexisTeal, NexisTealLight, NexisWhite))
            )
...
private fun AuthButton(
    ...
    OutlinedButton(
        ...
        border = androidx.compose.foundation.BorderStroke(1.dp, ButtonBorderGray),
        colors = ButtonDefaults.outlinedButtonColors(
            containerColor = NexisWhite,
